...
Extract HOG features and run logistic regression
'''
...
num_folds = 5
random_seed = 1
baseline_y_hat_prob, baseline_y_hat_class = cv_performance_assessment(X, y, num_folds, base_model, random_seed=random_seed)


'''
Model 2: K-nearest neighbor
Extract HOG features and run K-nearest neighbors
'''
...
# define KNN - hyperparameters were chosen based on 5-fold cross-validation
...
num_folds = 5
random_seed = 1
hog_knn_y_hat_prob, hog_knn_y_hat_class = cv_performance_assessment(
    X, y, num_folds, knn, random_seed=random_seed)
...
def plot_roc(y_true, y_pred_baseline, y_pred_knn, y_pred_cnn):
    '''
    Plots ROC curve for the baseline, KNN and CNN models.
    '''
...
def plot_pr(y_true, y_pred_baseline, y_pred_knn, y_pred_cnn):
    '''
    Plots PR curve for the baseline, KNN and CNN models.
    '''

    plt.figure(figsize=(8, 8))

    # precision-recall of cnn model
    ...
    # precision-recall of hog and knn model
    ...
    # precision-recall of baseline model
