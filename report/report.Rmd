...
author: "Team 3: Amandeep Rathee, Alena Kalodzitsa, Juan David Martinez Gordillo, Shota Takeshima, and Xiao Lu"
date: "3/4/2020"
output: pdf_document
---
...
![Positive examples of solar panels](./resources/label1_samples.png){width=50%}

![Negative examples of solar panels](./resources/label0_samples.png){width=50%}
...
![True-positive, True-negative, False-positive and False-negative Images from the KNN Model on Aerial Imagery Data.](./resources/hog-knn-result.png){width=60%}
...
![True-positive, True-negative, False-positive and False-negative Images from the CNN Model on Aerial Imagery Data.](./resources/cnn-result.png){width=60%}
